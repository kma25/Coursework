...
{
    /// <summary>
    /// Точка входа основного консольного приложения.
    /// </summary>
    internal static class Program
    {
        /// <summary>
        /// Настраивает сервисы, проверяет инфраструктуру и запускает цикл входа пользователей.
        /// </summary>
        ...
        /// <summary>
        /// Читает пароль из консоли с маскированием вводимых символов.
        /// </summary>
        /// <returns>Пароль, введенный пользователем.</returns>
